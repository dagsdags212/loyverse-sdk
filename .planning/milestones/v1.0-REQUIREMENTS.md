# Requirements Archive: v1.0 Initial Cleanup
...
- [x] **CLN-01**: Remove orphaned `models/shift.py` (no endpoint, no client integration, no tests)
- [x] **CLN-02**: Remove dead `utils.py` functions (`convert_response`, `use_model`)
- [x] **CLN-03**: Remove dead `db/schemas.py` (unused SQLModel schema)
- [x] **CLN-04**: Remove dead `core/logging.py` stub
